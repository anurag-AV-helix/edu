...
export const syllabus = [
  ...
  [
    "Python reserved words syntaxes",
    "Naming conventions",
    "Data type, conversions & comments",
    "String operations, basic functions",
    "If-else statements, While loop, for loop",
    "Arrays Lists tuples, sets, dictionaries",
    "OOPS Defining your own functions with parameters, classes & functions",
    "Inheretance, Super method",
    "Errors & exception handling",
    "Python applications: Tier 1, 2, 3 prgms",
    "File handling",
    "Advanced python functions",
    "Numpy. Matplottib & Pandas bootcamp",
    "Introduction to python turtle",
    "Learning to create patterns & shapes",
    "Setting up game environment & developing games",
  ],

  [
    "Introduction to data science",
    "Mathematical & statistical skills",
    "Machine leaming & its algorithms",
    "Coding",
    ...
    "Matrix computations",
    "Scholastic models",
    "Experimentation, evaluation & project deployment tools",
...
export const icons = [
  "/pricing/illustration_maintenance.svg",
  "/pricing/illustration_motivation.svg",
  "/pricing/illustration_seo.svg",
];
...
export const dashboardCardData = [
  {
    ...
    href: "http://3.110.238.1:3000/blockly/trafficSignal",
  },
  {
    title: "Bee & Honey",
    tags: ["tag1", "tag2", "tag3"],
    ...
    status: "done",
    img: "/imgs/rabbitImg.png",
    href: "http://3.110.238.1:3000/blockly/bee",
  },
  {
    title: "Bunny & Carrot",
    tags: ["tag1", "tag2", "tag3"],
    ...
    status: "start",
    img: "/imgs/rabbitImg.png",
    href: "http://3.110.238.1:3000/blockly/bunny",
  },
  {
    title: "Farm",
    tags: ["tag1", "tag2", "tag3"],
    desc: "Help animals to go to their homes",
    ratings: undefined,
    status: "locked",
    img: "/imgs/rabbitImg.png",
    href: "http://3.110.238.1:3000/game/farm",
  },
  {
    title: "Hello World",
    tags: ["tag1", "tag2", "tag3"],
    ...
    status: "locked",
    img: "/imgs/tip0.png",
    href: "http://3.110.238.1:3000/script",
  },
  {
    title: "Bunny & Carrot",
    tags: ["tag1", "tag2", "tag3"],
